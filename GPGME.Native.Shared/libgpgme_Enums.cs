...
namespace Libgpgme.Interop
{
    ...
    public enum gpgme_data_encoding_t
    {
    ...
    public enum gpgme_pubkey_algo_t
    {
    ...
    public enum gnupg_cipher_algo_t
    {
        CIPHER_ALGO_NONE = 0,
        CIPHER_ALGO_IDEA = 1,
        CIPHER_ALGO_3DES = 2,
    ...
    public enum gnupg_compress_algo_t
    {
    ...
    [Flags]
    public enum gpgme_keylist_mode_t : uint
    {
    ...
    [Flags]
    public enum gpgme_sig_notation_flags_t
    {
    ...
    public enum gpgme_status_code_t
    {
        GPGME_STATUS_EOF,
    ...
    public enum gpgme_encrypt_flags_t
    {
        NONE = 0,
